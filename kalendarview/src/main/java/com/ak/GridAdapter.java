...
//        this.todayIndicator = todayIndicator;
    ...
    public View getView(int position, final View convertView, final ViewGroup parent) {
        ...
        if (displayMonth == currentMonth && displayYear == currentYear) {
            ...
            cellNumber.setTextColor(colorToSet);
            cellNumber.setTag(0);
        } else {
            ...
            nonMonthDateColor = Color.parseColor("#939396");
            cellNumber.setTextColor(nonMonthDateColor);
        }
        //Add day to calendar
        //TextView cellNumber = (TextView)view.findViewById(R.id.calendar_date_id);
        ...
        if (displayMonth == toMonth && displayYear == toYear && dayValue == toDay) {
          ...
          /*  else
            ...
            cellNumber.setTag(-1);
            if (todayDateColor != 0)
                cellNumber.setTextColor(ContextCompat.getColor(getContext(), todayDateColor));
        }
